  ...
  var b111 = makeBranch("Leave your Oddish behind.", "You venture off from gym, the saddness of your Oddish's soul weighing against you. Do you.", "oddish");
  var b112 = makeBranch("Prepare to take back your Oddish.", "You and your Squirtle bond as you form an epic training montage preparing for the upcoming battle.", "squirtle");
  ...
  var b1112 = makeBranch("Take a break?", "Squritle knows you're not a quitter. Don't let him down. Do you.", "teamRocketGrunt");
  ...
  var b11121 = makeBranch("Get Revenge and fight Team Rocket to get oddish back?", "You run into the Team Rocket member who stole your pokemon. He looks pretty scary. Do you.", "teamRocketGrunt");
...
exports.handler = function( event, context ) {
    ...
    if (event.request.type === "LaunchRequest") {
        ...
        if (IntentName === "ActionResponseIntent") {
            ...
            var response = event.request.intent.slots.response.value;
            response = letToNum[response];
            if (response === 4) {
              say = currBranch.getSubjectDescription();
              context.succeed({sessionAttributes: sessionAttributes, response: buildSpeechletResponse(say, shouldEndSession) });
            }
            else {
