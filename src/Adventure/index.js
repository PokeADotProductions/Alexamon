...
exports.handler = function( event, context ) {
  ...
  var b = makeBranch("", "You come across a pikachu.", "bulbasaur")

  // console.log( new Branch("hint", "flavor", [], false, false));

  b.addBranch(makeLeaf("pick it up", "the pikachu shocks you and you die", false, null))
  var leaveIt = makeBranch("walk away", "it follows you to the pokemon center.", null)
  b.addBranch(leaveIt);
    var healit = makeBranch("heal it", "it now trusts you and joins your team.", null)
    leaveIt.addBranch(healit)
    leaveIt.addBranch(makeLeaf("kick it", "it dies and you win the world", true, null))
